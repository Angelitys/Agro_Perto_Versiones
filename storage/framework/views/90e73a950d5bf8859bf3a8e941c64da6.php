<?php $__env->startSection('title', 'Dashboard - AgroPerto'); ?>
<?php $__env->startSection('description', 'Painel de controle do AgroPerto'); ?>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <?php if(auth()->user()->type === 'producer'): ?>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900"><?php echo e($activeProducts); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900"><?php echo e($totalStock); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900"><?php echo e($lowStockProducts); ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <a href="<?php echo e(route('products.create')); ?>" class="flex items-center p-4 bg-green-50 rounded-lg hover:bg-green-100 transition-colors">
                ...
                <a href="<?php echo e(route('products.index')); ?>" class="flex items-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
                ...
                <a href="<?php echo e(route('sales.index')); ?>" class="flex items-center p-4 bg-purple-50 rounded-lg hover:bg-purple-100 transition-colors">
                ...
                <a href="<?php echo e(route('profile.edit')); ?>" class="flex items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <a href="<?php echo e(route('products.index')); ?>" class="text-green-600 hover:text-green-700 text-sm font-medium">Ver todos</a>
                </div>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center p-3 bg-gray-50 rounded-lg">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-sm text-gray-600"><?php echo e($product->category->name); ?> • R$ <?php echo e(number_format($product->price, 2, ',', '.')); ?></p>
                            </div>
                            <span class="text-sm text-gray-500"><?php echo e($product->stock_quantity); ?> <?php echo e($product->unit); ?></span>
                        </div>
                ...
                <?php else: ?>
                    <div class="text-center py-8">
                        ...
                        <a href="<?php echo e(route('products.create')); ?>" class="text-green-600 hover:text-green-700 font-medium">Cadastrar primeiro produto</a>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="bg-red-100 text-red-800 text-xs px-2 py-1 rounded-full"><?php echo e($lowStockProducts); ?> produtos</span>
                </div>
                
                <?php if($lowStockProductsList->count() > 0): ?>
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center p-3 bg-red-50 rounded-lg">
                            ...
                            <div class="flex-1">
                                <p class="font-medium text-gray-900"><?php echo e($product->name); ?></p>
                                <p class="text-sm text-gray-600"><?php echo e($product->category->name); ?></p>
                            </div>
                            <span class="text-sm font-medium text-red-600"><?php echo e($product->stock_quantity); ?> <?php echo e($product->unit); ?></span>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                <?php else: ?>
    ...
    <?php else: ?>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
            <h2 class="text-lg font-semibold text-gray-900 mb-4">Ações Rápidas</h2>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <a href="<?php echo e(route('products.index')); ?>" class="flex items-center p-4 bg-green-50 rounded-lg hover:bg-green-100 transition-colors">
                    <svg class="w-8 h-8 text-green-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('cart.index')); ?>" class="flex items-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
                    <svg class="w-8 h-8 text-blue-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                        ...
                        <h3 class="font-medium text-gray-900 mb-1"><?php echo e($product->name); ?></h3>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="<?php echo e(route('products.show', $product)); ?>" class="text-green-600 hover:text-green-700 text-sm font-medium">Ver</a>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-gray-600"><?php echo e($category->products_count); ?> produtos</p>
                        </div>
...
<?php echo $__env->make('layouts.marketplace', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\angel\Desktop\agro-marketplace-final\resources\views/dashboard.blade.php ENDPATH**/ ?>