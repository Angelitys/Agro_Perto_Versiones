            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <a href="#" class="flex items-center p-4 bg-purple-50 rounded-lg hover:bg-purple-100 transition-colors">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">Ver estatísticas</p>
                    </div>
                </a>
...
<?php echo $__env->make('layouts.marketplace', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\angel\Desktop\agro-marketplace-dashboard\resources\views/dashboard.blade.php ENDPATH**/ ?>