...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-label','data' => ['for' => 'type','value' => 'Tipo de Conta','class' => 'mb-3 text-base font-semibold']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['for' => 'type','value' => 'Tipo de Conta','class' => 'mb-3 text-base font-semibold']); ?>
...
<?php endif; ?>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <label class="relative cursor-pointer">
                    <input type="radio" name="type" value="producer" class="sr-only peer" <?php echo e(old('type') === 'producer' ? 'checked' : ''); ?> required>
                ...
                <!-- Consumidor -->
                <label class="relative cursor-pointer">
                    <input type="radio" name="type" value="consumer" class="sr-only peer" <?php echo e(old('type') === 'consumer' ? 'checked' : ''); ?> required>
...
<?php endif; ?>
        ...
        <div class="flex items-center justify-between mt-6">
            <a class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500" href="<?php echo e(route('login')); ?>">
                Já tem uma conta?
            </a>

            <?php if (isset($component)) { $__componentOriginald411d1792bd6cc877d687758b753742c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald411d1792bd6cc877d687758b753742c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-button','data' => ['class' => 'bg-green-600 hover:bg-green-700 focus:bg-green-700 active:bg-green-900']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'bg-green-600 hover:bg-green-700 focus:bg-green-700 active:bg-green-900']); ?>
                Criar Conta
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\angel\Desktop\agro-marketplace-final\resources\views/auth/register.blade.php ENDPATH**/ ?>