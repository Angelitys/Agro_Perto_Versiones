                    ...
                    <div class="mb-6">
                        ...
                        <div class="space-y-3">
                            <label class="flex items-center p-3 border border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50">
                                <input type="radio" name="payment_method" value="cash" class="text-green-600 focus:ring-green-500" {{ old('payment_method') == 'cash' ? 'checked' : '' }}>
                                <div class="ml-3">
                            ...
                            <label class="flex items-center p-3 border border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50">
                                <input type="radio" name="payment_method" value="pix" class="text-green-600 focus:ring-green-500" {{ old('payment_method') == 'pix' ? 'checked' : '' }}>
                                <div class="ml-3">
                                    <div class="text-sm font-medium text-gray-900">
