                        ...
                        <div class="p-6">
                            ...
                            <div class="mt-6">
                                <form action="{{ route("checkout.store") }}" method="POST">
                                    @csrf
                                    <div class="mt-6 pt-6 border-t border-gray-200">
                                        <h2 class="text-lg font-semibold text-gray-900 mb-4">Agendamento de Retirada</h2>
                                        
                                        <div class="mb-4">
                                            <label for="pickup_date" class="block text-sm font-medium text-gray-700 mb-1">Data de Retirada</label>
                                            <input type="date" name="pickup_date" id="pickup_date" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm" required value="{{ old('pickup_date', date('Y-m-d', strtotime('+1 day'))) }}" min="{{ date('Y-m-d', strtotime('+1 day')) }}">
                                        </div>
                                        
                                        <div class="mb-4">
                                            <label for="pickup_time" class="block text-sm font-medium text-gray-700 mb-1">Horário de Retirada</label>
                                            <select name="pickup_time" id="pickup_time" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm" required>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <select name="payment_method" id="payment_method" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm" required>
                                        ...
                                        <div class="mb-4">
                                            <label for="pickup_notes" class="block text-sm font-medium text-gray-700 mb-1">Observações (opcional)</label>
                                            <textarea name="pickup_notes" id="pickup_notes" rows="2" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm" placeholder="Alguma observação sobre o pedido?">{{ old('pickup_notes') }}</textarea>
                                        </div>
                                    </div>
