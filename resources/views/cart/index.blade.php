    ...
    <form action="{{ route("checkout.store") }}" method="POST">
        ...
        <div class="mt-6 pt-6 border-t border-gray-200">
            ...
            <div class="mb-4">
                ...
                <input type="date" name="pickup_date" id="pickup_date" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm" required value="{{ old('pickup_date') }}">
            </div>
        </div>
