...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('reviews', function (Blueprint $table) {
            $table->id();
            $table->foreignId('user_id')->constrained()->onDelete('cascade'); // Cliente que avalia
            ...
            $table->integer('product_rating')->nullable(); // Avaliação do produto (1-5)
            $table->integer('producer_rating')->nullable(); // Avaliação do produtor (1-5)
            ...
            // Garantir que um usuário só pode avaliar uma vez por pedido/produto
